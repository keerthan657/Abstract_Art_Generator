...
public class DrawableBox_Square extends DrawableBox
{
    int complexity, size;
    String style;

    public DrawableBox_Square(int complexity, int size, String style)
    {
    ...
    public void draw(Group layout)
    {
        ...
        if(style.equals("Chaotic")) {
            for (int i = 0; i < (int) (complexity / 2); i++) {
                ...
                rectangle[i].setWidth(size * temp);
                rectangle[i].setHeight(size * temp);
